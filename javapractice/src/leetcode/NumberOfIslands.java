 ...
 * @author SIVA SAI
 *
 * LeetCode Ques : 200 {Number of Islands}
...
public class NumberOfIslands {
	...
	System.out.println("Number of Islands = " +calClusterCnt(M)); // Expected Output = 6

	/*
	 * // Deep Cloning Multi-Dimensional Array int N[][]= new int[5][5]; for(int
	 * k=0;k<M.length;k++) { // N[k]=Arrays.copyOf(M[k], M[k].length); {copyOf
	 * internally uses system.arraycopy} // OR // System.arraycopy(M[k], 0, N[k], 0,
	 * M[k].length); } System.out.println(Arrays.deepToString(N));
