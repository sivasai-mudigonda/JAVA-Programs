...
* @author u230107
*
* LeetCode Ques - 277 {Find the Celebrity}
...
*
* Time Complexity =O(N) -Loop through n people
...
public class FindCelebrity {
	...
	public static void main(String[] args) {
		...
		System.out.println("Celebrity = " + obj.findCelebrity(1));
	}
	...
	public int findCelebrity(int n) {
		...
		int celeb = 0; // Let us start with an assumption that 0 is the celebrity
		...
		/*
		 * To make sure the value we find out is actually the celebrity, we check if
		 * celeb knows none and everyone knows him.
		 */
		for (int i = 0; i < n; i++) {
